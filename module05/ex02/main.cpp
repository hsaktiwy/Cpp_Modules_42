...
// int main()
// {
// 	PresidentialPardonForm f1("Hamza");
// 	ShrubberyCreationForm f2("ST1");
// 	RobotomyRequestForm	f3("Printer");
// 	Bureaucrat b1("Saktiwy", 120);
// 	Bureaucrat b2("New_Plus", 1);
// 	Bureaucrat b3("Sana", 60);

// 	b1.signForm((AForm &)f1);
// }
int main()
{
	{
